...
with np.load('C:/Users/Christian/Desktop/MECCATRONICA/Tesi/codetests/Proper/CamParams.npz') as X:
...
for fname in glob.glob('C:/Users/Christian/Desktop/MECCATRONICA/Tesi/codetests/Proper/resize/*.jpg'):
    img = cv.imread(fname)
